from features.schedule_feasibility import index_by_canonical_id
...
for row in rows:
    ...
    if progress_change is not None:
        velocity = progress_change / elapsed_months
    else:
        velocity = None
